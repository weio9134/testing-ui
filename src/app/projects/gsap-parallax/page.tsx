...
const page = () => {
  useGSAP(() => {
    ...
    scene1.to("#h1-2", { y: 2.6 * speed, x: -0.6 * speed, ease: "power1.in" });
    ...
    sun.to("#bg_grad stop:nth-child(6)", { attr: { stopColor: "#FF9171" } });
    ...
    // stars
    scene3.fromTo("#stars", { opacity: 0 }, { opacity: 0.5, y: -500 });

    // gradient change
    scene3.to("#bg2-grad", { attr: { cy: 600 } });
    scene3.to("#bg2-grad", { attr: { r: 500 } });
  ...
  return (
    <section className="min-h-screen w-screen absolute">
      <svg
